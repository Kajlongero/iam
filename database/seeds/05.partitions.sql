...
CREATE TABLE
  access_control.application_user_roles_food_app_3 PARTITION OF access_control.application_user_roles FOR
VALUES
  IN (3);

CREATE TABLE
  security.sessions_food_app_3 PARTITION OF security.sessions FOR
VALUES
  IN (3);

CREATE TABLE
  access_control.role_authority_restrictions_food_app_3 PARTITION OF access_control.role_authority_restrictions FOR
VALUES
  IN (3);

CREATE TABLE
  security.authorization_codes_food_app_3 PARTITION OF security.authorization_codes FOR
VALUES
  IN (3);

CREATE TABLE
  security.authorization_code_scopes_food_app_3 PARTITION OF security.authorization_code_scopes FOR
VALUES
  IN (3);